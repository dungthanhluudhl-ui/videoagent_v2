...
| File | Responsibility |
|---|---|
| `src/primitives/DocumentEvidence.jsx` | Authentic raster/document presentation, truthful crop/focus/highlight; never fake retyped evidence |
| `src/primitives/MapGraphic.jsx` | Real map plate/data with route and annotations |
| `src/primitives/DataChart.jsx` | Bar/line/pie from real numeric data; no variety-only charts |
...
| `src/primitives/RelationDiagram.jsx` | Minimal exception-only relationship representation requiring `diagramJustification` |
