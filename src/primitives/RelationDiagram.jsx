export const RelationDiagram = ({items = [], relations = [], materialId, style}) => {
  if (!materialId) throw new Error("RelationDiagram requires approved diagram-exception materialId");
  return (
