...
export const DataChart = ({data, materialId, type = "bar", color = "#FF6A1A", ink = "#141414", revealProgress = 1, style}) => {
  if (!materialId) throw new Error("DataChart requires approved numeric materialId");
