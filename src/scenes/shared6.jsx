...
import { CAPTION_LINES6 } from "../captionData6";
import { useCurrentFrame } from "remotion";

export const Captions6 = () => {
  const frame = useCurrentFrame();
  const activeLineIndex = CAPTION_LINES6.findIndex((line) => {
  ...
  const line = CAPTION_LINES6[activeLineIndex];
