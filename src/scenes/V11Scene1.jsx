...
export const V11Scene1 = () => (
  <AbsoluteFill name="V11Scene1">
    <BackgroundPhoto name="Bg-Decree" src="el10_historical_doc.png"
                     durationInFrames={102} wash="paper" tint={0.5}
                     grayscale={0.7} focus="50% 35%" drift={0.05} />

    {/* cuộn chiếu chỉ: hai thanh trục kéo ngang ra, mặt giấy mở giữa chúng */}
    <DiagramCanvas y={280} height={360}>
      <DrawnPath d="M 90 24 L 990 24" delay={0} drawFrames={14} length={900} strokeWidth={14} />
      <DrawnPath d="M 90 336 L 990 336" delay={6} drawFrames={14} length={900} strokeWidth={14} />
      <DrawnPath d="M 96 24 L 96 336" delay={12} drawFrames={8} length={320} strokeWidth={4} />
      <DrawnPath d="M 984 24 L 984 336" delay={12} drawFrames={8} length={320} strokeWidth={4} />
      {/* ấn triện - dấu hiệu duy nhất cho biết đây là văn bản của triều đình */}
      <g opacity={0.9}>
        <DrawnPath d="M 880 250 L 950 250 L 950 320 L 880 320 Z" delay={20} drawFrames={12}
                   length={280} stroke="#C2410C" strokeWidth={7} />
        <DrawnPath d="M 896 268 L 934 268 M 896 286 L 934 286 M 896 304 L 934 304"
                   delay={26} drawFrames={10} length={120} stroke="#C2410C" strokeWidth={5} />
      </g>
    </DiagramCanvas>

    <Sequence from={34} layout="none">
      <PunchPhrase lines={["TRIỀU ĐÌNH", "LẬP KHU TẠM CƯ"]} top={352} fontSize={64} />
    </Sequence>
