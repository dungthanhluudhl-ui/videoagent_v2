  ...
  <AbsoluteFill name="V11Scene18">
    ...
    <DiagramCanvas y={330} height={430}>
      <DrawnPath d="M 540 40 m -150 0 a 150 150 0 1 0 300 0 a 150 150 0 1 0 -300 0"
                 delay={0} drawFrames={26} length={950} strokeWidth={8} />
    ...
    <DiagramCanvas y={790} height={460}>
      ...
      <DrawnPath d="M 260 40 L 380 170 L 260 300" delay={100} drawFrames={14} length={360}
                 strokeWidth={6} />
      <DrawnPath d="M 820 40 L 700 170 L 820 300" delay={106} drawFrames={14} length={360}
                 strokeWidth={6} />
