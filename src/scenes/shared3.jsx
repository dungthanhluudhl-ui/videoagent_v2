...
import { CAPTION_LINES3 } from "../captionData3";
import { useCurrentFrame } from "remotion";

export const Captions3 = () => {
  const frame = useCurrentFrame();
  const activeLineIndex = CAPTION_LINES3.findIndex((line) => {
  ...
  const line = CAPTION_LINES3[activeLineIndex];
