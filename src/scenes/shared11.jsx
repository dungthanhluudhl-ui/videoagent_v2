...
import { CAPTION_LINES11 } from "../captionData11";
import { useCurrentFrame } from "remotion";

// Video-specific caption wiring only (same pattern as shared9.jsx/shared10.jsx)
// - all real primitives (Hero, Support, SceneBackground, etc.) are the
// canonical ones in ./shared, reused directly, not duplicated here.
export const Captions11 = () => {
  const frame = useCurrentFrame();
  const activeLineIndex = CAPTION_LINES11.findIndex((line) => {
  ...
  const line = CAPTION_LINES11[activeLineIndex];
