...
const Swap = ({ cx, oldText, newText, delay }) => (
  <g>
    <text x={cx} y={60} textAnchor="middle" fill="#1A1A1A" opacity={0.45}
    ...
    <text x={cx} y={196} textAnchor="middle" fill="#C2410C"
...
export const V11Scene9 = () => (
  <AbsoluteFill name="V11Scene9">
    ...
    <DiagramCanvas y={392} height={470}>
      ...
      <text x={540} y={352} textAnchor="middle" fill="#1A1A1A"
            style={{ fontFamily: "Be Vietnam Pro", fontSize: 58, fontWeight: 900, letterSpacing: 6 }}>
        I · TAE · WON
      </text>
      <text x={540} y={412} textAnchor="middle" fill="#1A1A1A" opacity={0.7}
