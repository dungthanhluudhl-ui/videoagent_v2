...
import { CAPTION_LINES9 } from "../captionData9";
import { useCurrentFrame } from "remotion";

export const Captions9 = () => {
  const frame = useCurrentFrame();
  const activeLineIndex = CAPTION_LINES9.findIndex((line) => {
  ...
  const line = CAPTION_LINES9[activeLineIndex];
