...
import { CAPTION_LINES4 } from "../captionData4";
import { useCurrentFrame } from "remotion";

export const Captions4 = () => {
  const frame = useCurrentFrame();
  const activeLineIndex = CAPTION_LINES4.findIndex((line) => {
  ...
  const line = CAPTION_LINES4[activeLineIndex];
