...
import { CAPTION_LINES8 } from "../captionData8";
import { useCurrentFrame } from "remotion";

export const Captions8 = () => {
  const frame = useCurrentFrame();
  const activeLineIndex = CAPTION_LINES8.findIndex((line) => {
  ...
  const line = CAPTION_LINES8[activeLineIndex];
