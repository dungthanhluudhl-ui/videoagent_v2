...
const Half = ({ cx, title, gloss, delay, accent }) => (
  <g>
    ...
    <text x={cx} y={128} textAnchor="middle" fill="#1A1A1A"
    ...
    <text x={cx} y={236} textAnchor="middle" fill="#1A1A1A"
...
export const V11Scene4 = () => (
  <AbsoluteFill name="V11Scene4">
    ...
    <DiagramCanvas y={740} height={510}>
      ...
      <text x={880} y={92} textAnchor="middle" fill="#C2410C"
            style={{ fontFamily: "Be Vietnam Pro", fontSize: 34, fontWeight: 900 }}>
        CHỮ LÊ
      </text>
      <text x={880} y={140} textAnchor="middle" fill="#1A1A1A"
